  ...
  Future<void> _showAiSummary(AppLocalizations l) async {
    ...
    try {
      ...
      final result = await ai.request(
        '以下の自然栽培の記録データを分析して要約してください。\n\n'
        '## 栽培情報\n$cropInfo\n\n'
        '## 活動タイムライン\n$timelineText\n\n'
        '以下の観点で報告してください：\n'
        '1. 観察の振り返り — 記録から読み取れる植物と土の変化\n'
        '2. 土壌の状態 — 記録から推測できる土の力と生態系の様子\n'
        '3. 次に観察すべきポイント — 今後注目すべき変化や兆候\n'
        '日本語で回答してください。',
        systemPrompt:
            'あなたは自然栽培のコワーカーです。'
            '農薬・化学肥料は使いません。'
            '慣行農業の「効率化・最適化」ではなく、'
            '土壌の状態、土地の生態系、植物の自然な力を軸にアドバイスしてください。'
            '観察を深める問いかけを大切にしてください。',
      );
