  ...
  Future<void> _analyze() async {
    ...
    try {
      ...
      final result = await ai.analyzeImage(
        ...
        '以下の自然栽培の記録写真を観察してください。$context\n'
        '以下の観点で簡潔に日本語で説明してください：\n'
        '・植物の生育段階と葉や茎の様子（色・艶・形）\n'
        '・土の表面の状態（色・湿り気・団粒構造・被覆の様子）\n'
        '・周囲の草や虫、微生物の気配（生態系の多様性）\n'
        '・全体の印象（土地の力を感じるか、植物に勢いがあるか）\n'
        '記録メモとして使える2-3行の観察文で回答してください。',
        systemPrompt:
            'あなたは自然栽培の観察パートナーです。'
            '農薬や化学肥料は使いません。'
            '植物そのものだけでなく、土壌の状態・周囲の生態系・土地全体の様子を'
            '丁寧に観察して報告してください。',
      );
