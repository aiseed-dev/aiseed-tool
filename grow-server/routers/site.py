...
async def generate(data: SiteData, request: Request, user=Depends(require_feature("site"))):
...
async def request_generation(
    data: SiteData,
    user=Depends(require_feature("site")),
...
@router.post("/deploy")
async def deploy(req: DeployRequest, request: Request, user=Depends(require_feature("site"))):
